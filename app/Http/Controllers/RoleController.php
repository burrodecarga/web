...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $btn = "create";
        $permissions_id = [];
        return view('roles.create', compact('permissions', 'role', 'btn', 'permissions_id', 'title'));
    }
    ...
    public function show(Role $role)
    {
        ...
        return view('roles.show', compact('permissions', 'role', 'btn', 'permissions_id', 'title'));
    }
    ...
    public function edit(Role $role)
    {
        ...
        $btn = "update";
        $permissions_id = $role->permissions->pluck('id')->toArray();
        return view('roles.edit', compact('permissions', 'role', 'btn', 'permissions_id', 'title'));
    }
